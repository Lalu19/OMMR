...
function Loading(Checker, callback) {
   //var LoadingImage = "../../Content/loading/loading_flower.gif"; //29x29

    //var LoadingImage = "~/Content/loading/loading_flower.gif";
    var LoadingImage = "../../plugins/loading/loading_flower.gif";
